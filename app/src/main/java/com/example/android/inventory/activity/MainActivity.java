...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void insertDummyProduct() {
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_NAME, "テスト商品");
        values.put(ProductEntry.COLUMN_PRODUCT_AUTHOR, "テストメーカー");
        values.put(ProductEntry.COLUMN_PRODUCT_PUBLISHER, "テストメーカー");
        values.put(ProductEntry.COLUMN_PRODUCT_ISBN, "123456");
        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, 500);
        values.put(ProductEntry.COLUMN_PRODUCT_QUANTITY, 10);
        values.put(ProductEntry.COLUMN_SUPPLIER_NAME, "テストサプライヤー");
        values.put(ProductEntry.COLUMN_SUPPLIER_EMAIL, "test@email.com");
        values.put(ProductEntry.COLUMN_SUPPLIER_PHONE, "(123) 456-7899");
